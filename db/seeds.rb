...
Meal.create(name:"Maçã", description: "Uma maçã muito deliciosa",available: true, price: "8,00")
Meal.create(name:"Banana", description: "A preferida dos macacos",available: true, price: "4,00")
